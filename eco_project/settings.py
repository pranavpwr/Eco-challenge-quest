...
# Custom settings for EcoQuest
POINTS_PER_LEVEL = 100  # Points needed to level up
INITIAL_BIOME_POINTS = 0  # Starting points for first biome
MAX_TASKS_PER_DAY = 5  # Maximum tasks a user can complete per day
